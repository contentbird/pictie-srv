...
(function() {
  ...
  var faye, http, _app, _memory_users, _redis_users,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  http = require('http', faye = require('faye', _app = require('./app', _memory_users = require('./memory_users_manager', _redis_users = require('./redis_users_manager')))));
  ...
  this.Server = (function() {
    ...
    Server.prototype.initApp = function() {
      return this.app.init(this.bayeux, this.users_manager);
    };
